...
def criar_matriz(n_linhas, n_colunas, mensagem):
    """Cria uma matriz 3x3 com base nos valores fornecidos pelo usuário."""
    print(mensagem)
    matriz = []
...
# Solicita ao usuário para criar as matrizes 3x3
A = criar_matriz(3, 3, "Insira os valores para a Matriz A (3x3):")
B = criar_matriz(3, 3, "Insira os valores para a Matriz B (3x3):")
